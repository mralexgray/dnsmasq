...
#ifndef  __APPLE_USE_RFC_3542 /* Define before netinet/in.h to select API. OSX Lion onwards. */
...
#define              LOG_MAX 22 // log-queue length
...
#define HAVE_GETOPT_LONG
#define HAVE_SOCKADDR_SA_LEN
/* Define before sys/socket.h is importd so we get socklen_t */
#define _BSD_SOCKLEN_T_
/* Select the RFC_3542 version of the IPv6 socket API. 
   Define before netinet6/in6.h is importd. */
